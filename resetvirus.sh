...
'
echo " " 
echo -e "$red                       ▶Coded by$grn ɪɴɴᴏᴄᴇɴᴛ ＤＲ４Ｇ０Ｎ$red◀$rset"
echo -e "$red                      ⫸$ylo  𝙎𝙃𝘼𝙃𝘼𝙍𝙄𝘼𝙍 𝙕𝘼𝙈𝘼𝙉$red ⫷$rset"
echo 
# Functions
...
echo -e "$red                        ➡$cyan [\e[92m5\e[96m] Follow My Profile"
...
then
am start -a android.intent.action.VIEW -d https://www.facebook.com/Facebook.Recover.Specialist.1 > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://github.com/shahariar001M > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
am start -a android.intent.action.VIEW -d https://t.me/DR4GONGang > /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
...
echo -e "\e[93m             IAM FROM \e[92mɪɴɴᴏᴄᴇɴᴛ ＤＲ４Ｇ０ＮS" | pv -qL 10
...
echo -e "\e[93m        MY Facebook Profile:\e[92m www.facebook.com/shahariarzaman.2022\e[0m" | pv -qL 10
...
clear
echo -e "\e[96m                ╔═══════════════════════════════════╗\e[0m"
echo -e "\e[96m                ║  \e[93mHY, I JUST UPLOADED NEW\e[96m VIRUS    ║\e[0m"
echo -e "\e[96m                ║      USE IT NOW FOR FUN.....!     ║\e[0m"
echo -e "\e[96m                ║                                   ║\e[0m"
echo -e "\e[96m                ║        Select \e[92my\e[96m to continue \e[96m      ║\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://www.facebook.com/shahariarzaman.2022 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
